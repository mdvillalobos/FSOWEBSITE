        ...
        <div className='flex justify-between'>
            <div className='flex justify-between flex-col space-y-4'>
                <div className="inputContainer">
                  ...
                  <input type="text" id="Name" className='inputFields pointer-events-none' value={name} disabled/>
                </div>
                <div className="inputContainer">
                ...
                <div className="inputContainer">
                  ...
                  <input type="text" id="department" className='inputFields pointer-events-none' value={department} disabled/>
                </div>
            </div>
            <div className='flex justify-between flex-col space-y-4'>
                <div className="inputContainer">
                  <label htmlFor="rank" className='text-sm font-normal'>Current Rank:</label>
                  <input type="text" id="rank" className='inputFields pointer-events-none' value={currentRank} disabled/>
                </div>
                <div className="inputContainer">
                ...
                <div className="inputContainer">
                  ...
                  <input type="text" id="term" className='inputFields'  defaultValue={academicYear} onChange={(e) => setData({...data, academicYear: e.target.value})}/>
                </div>
            </div>
        </div>
      </div>
