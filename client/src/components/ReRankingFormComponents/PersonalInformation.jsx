    ...
    <div className="">
      <div className='border-t-2 border-b-2 border-[#35408E] py-4'>
        ...
        <div className='flex justify-between max-sm:flex-col'>
          <div className='flex justify-between flex-col space-y-4 max-sm:space-y-2'>
          ...
          <div className='flex justify-between flex-col space-y-4 max-sm:space-y-2 max-sm:mt-2'>
            <div className="inputContainer">
            ...
            <div className="inputContainer">
              ...
              <input type="text" id="status" className='inputFields' defaultValue='' disabled/>
            </div>
            <div className="inputContainer">
